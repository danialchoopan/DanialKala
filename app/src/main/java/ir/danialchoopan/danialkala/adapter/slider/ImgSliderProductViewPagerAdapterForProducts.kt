...
import ir.danialchoopan.danialkala.data.model.requests.showCategory.Productphotos
import kotlinx.android.synthetic.main.row_img_slider_item.view.*

class ImgSliderProductViewPagerAdapterForProducts(val m_context: Context, val ar_data: List<Productphotos>) :
    PagerAdapter() {
